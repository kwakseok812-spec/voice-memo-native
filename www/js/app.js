...
(function () {
  ...
  var APP_VERSION = 'v4.9';       // M1: 화면에 표시해 대표님이 최신본인지 알게 한다 (v4.9: 네이티브 입력 UI 통일 — 네이티브 입력 바가 열리는 동안 웹 하단 바를 숨겨 '입력창 2개로 보이던' 이중구조 해소. 네이티브 바 색·둥근모서리·전송버튼 그라디언트를 웹 하단 바 톤과 일치시켜 이질감 제거, 딤 옅게. v4.8=채팅 입력 네이티브 전환.)
  // ── 음성 대화(핸즈프리) + 카메라 상태 ──
